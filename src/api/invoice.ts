...
// export const subject = localStorage.getItem("subject") as any || null;

// console.log(merchantList, token, subject)
...
export const simpleInvoice = async ({
    ...
    formdata.append("additionalCustomerEmailAddress", additionalCustomerEmailAddress);
    ...
    return await fetch(
        `${baseUrl}/api/v1/invoice/create-simple-invoice`,
        {
            method: "POST",
            headers: {
