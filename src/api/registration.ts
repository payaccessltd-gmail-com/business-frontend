...
export const activateAccount = async (otpBody: API.UserOTP) => {
  return await fetch(
    `${baseUrl}/api/v1/user/activate-account`,
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
...
export const resendOTP = async (resendOTPBody: API.ResendOTP) => {
  return await fetch(
    `${baseUrl}/api/v1/user/resend-signup-otp`,
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
...
export const forgetPassword = async (forgetPasswordBody: API.ForgetPassword) => {
  return await fetch(
...
export const OTP = async (OTPBody: API.OTP) => {
  return await fetch(
    `${baseUrl}/api/v1/auth/otp-validate`,
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
