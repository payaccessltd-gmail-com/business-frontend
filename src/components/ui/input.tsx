  ...
  return (
    <div className="relative">
      <input
        ...
        className={cn(
          "border-input/15 bg-background px-3 shadow-sm transition-colors file:border-0 file:bg-transparent file:text-sm file:font-medium  focus-visible:outline-none placeholder:text-neutral-300 focus-visible:ring-ring focus-visible:border-border disabled:cursor-not-allowed disabled:opacity-50 bg-white text-sm font-medium leading-snug w-full  rounded-lg border justify-start items-center  inline-flex py-3 text-cyan-800",
          className
        )}
        ref={ref}
        {...props}
