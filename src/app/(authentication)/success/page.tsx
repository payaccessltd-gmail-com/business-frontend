  ...
  return (
    <div className="flex h-full w-full flex-row items-center justify-center ">
      <div className=" sm:shadow-md w-full sm:w-[420px] rounded-[8px] px-[50px] py-[40px] flex flex-col items-center">
        <p className="text-[#021921] mb-10 text-[26px] text-center font-[600] leading-[150.9%]">Successful</p>
        ...
        <p className="text-[#354052] mb-10 text-[16px] text-center font-[400] leading-normal">Your email address has been successfully verified one more step and we are done</p>
        <Button
          // disabled={loading}
