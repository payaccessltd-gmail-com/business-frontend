    ...
    <div className="flex flex-row items-center justify-center w-full h-full ">
      <div className="h-[544px] max-[842px]:w-full w-[842px] max-[842px]:rounded-none rounded-[13px] bg-[white] max-[842px]:shadow-none shadow gap-6 flex flex-col items-center justify-center">
        ...
        <div className="flex flex-col items-center gap-2">
          <p className="text-[32px] text-center font-[700] leading-[125%] text-primary">Congratulation</p>
          <p className="text-[14px] text-center font-[400] leading-[145%] text-[#666]">You have successfully reset your password</p>
        </div>
        <Button
          // disabled={loading}
          className="w-[225px] min-h-[48px]"
          type="submit"
          asChild
        >
