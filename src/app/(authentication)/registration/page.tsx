...
export default function RegistrationPage() {
  return (
    <div className="flex flex-row w-full h-full ">
      <div className={`lg:flex hidden overflow-hidden login-bg relative w-[40%] pt-[70vh] h-full bg-primary/20 flex-col`}>
        ...
        <div className="z-[1] xl:ml-[125px] ml-[50px] flex flex-col items-start gap-4 w-[361px]">
      ...
      <ScrollArea className="relative lg:w-[60%] w-full h-full">
        <div className="pt-[140px] flex flex-col w-full h-full items-center xl:px-[160px] lg:px-[100px] md:px-[120px] sm:px-[200px] px-[20px]">
          <div className="absolute z-[1] top-0 bg-white w-full sm:px-[74px] px-[20px] pb-[30px] pt-[52px] flex flex-row items-center justify-between">
            <div>
              <BackButton />
            </div>
          ...
          <Typography className="text-center self-center mb-4 text-[32px] leading-[40px] font-black inline-block bg-transparent" level="h1">
