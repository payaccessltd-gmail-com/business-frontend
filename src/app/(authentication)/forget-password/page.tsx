...
export default function AuthenticationPage() {
  return (
    <div className="flex flex-row w-full h-full ">
      <div className={`lg:flex hidden login-bg pt-[70vh] overflow-hidden relative w-1/2 h-full  bg-primary/20 flex-col`}>
      ...
      <div className="relative flex flex-col lg:w-1/2 w-full h-full items-center justify-center xl:px-[160px] lg:px-[100px] md:px-[120px] sm:px-[200px] px-[20px]">
        <BackButton />
        {/* <Link href={"/login"} className="bg-white cursor-pointer absolute sm:left-[74px] left-[20px] top-[52px] flex flex-row items-center gap-[7px] text-[14px] font-[400] leading-[145%] text-[#000000]">
          <LuChevronLeft className="text-[24px] text-[#000000]" />
          Back
        </Link> */}
        {/* <Image className="mb-8" src={lock} alt={"lock"} /> */}
        <div className="mb-[13px] rounded-full h-[92px] w-[92px] bg-primary/5 flex flex-row items-center justify-center">
