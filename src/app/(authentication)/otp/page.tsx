...
export default function AuthenticationPage() {
  return (
    <div className="flex flex-row w-full h-full ">
      <div className={`lg:flex hidden overflow-hidden login-bg relative w-1/2 h-full bg-primary/20 pt-[70vh] flex-col`}>
      ...
      <div className="relative bg-[#F7FCFE] flex flex-col lg:w-1/2 w-full h-full items-center justify-center xl:px-[160px] lg:px-[100px] md:px-[120px] sm:px-[200px] px-[20px]">
        <BackButton />
