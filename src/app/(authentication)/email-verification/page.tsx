...
export default function AuthenticationPage() {
  return (
    <div className="relative flex flex-row w-full h-full ">
      <div className={`lg:flex hidden overflow-hidden login-bg relative w-[50%] pt-[70vh] h-full bg-primary/20 flex-col`}>
        <Image className="absolute z-0 xl:left-[100px] left-[50px] top-[48px]" src={Logo} alt={"logo"} />
        <Image className="absolute top-10 z-0" src={sideBg} alt={"sidebg"} />
      ...
      <ScrollArea className="relative lg:w-[50%] w-full h-full">
        <div className="lg:pt-[210px] pt-[180px] flex flex-col w-full h-full items-center xl:px-[160px] lg:px-[100px] md:px-[120px] sm:px-[200px] px-[20px]">
          ...
          <div className="mb-6 rounded-full h-[92px] w-[92px] bg-primary/10 flex flex-row items-center justify-center">
            <LiaEnvelopeOpenTextSolid className="text-[55px] text-primary" />
          </div>
