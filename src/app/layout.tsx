...
export default function RootLayout({
  ...
  return (
    <html
      lang="en"
      className={`${PlusJakartaSans.variable} ${CenturyGothic.variable} ${poppins.variable} ${dmsans.variable} ${raleway.variable} ${sfpro.variable} h-screen scroll-smooth antialiased`}
    >
