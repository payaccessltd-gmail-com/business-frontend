...
const PasswordSchema = z.object({
    currentPassword: z.string().min(2, "Password must contain more than 2 characters")
        .max(8, "Password must not be above 8 characters"),
    newPassword: z.string().min(2, "Password must contain more than 2 characters")
        .max(8, "Password must not be above 8 characters"),
    confirmPassword: z.string().min(2, "Password must contain more than 2 characters")
        .max(8, "Password must not be above 8 characters"),
