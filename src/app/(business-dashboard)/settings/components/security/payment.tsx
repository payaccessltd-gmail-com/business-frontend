...
export default function Payment({ data, security, setSecurity }: any) {
    ...
    return (
        <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="w-[60%] mb-5 p-[24px] rounded-[10px] flex flex-col gap-[36px] items-start bg-white shadow-[0px_4px_8px_0px_rgba(50,50,71,0.06)]">

                <div className="flex flex-row items-start gap-[125px]">
                    <p className="text-[black] text-[14] font-[400] leading-[145%]">
                        Default currency
                    </p>
                    <FormField
                                ...
                                >
                                    <FormControl>
                                        <SelectTrigger className="rounded-[10px] min-h-[56px] bg-[#F2FAFD] border-none w-[84px]">
                                            <SelectValue
                                                defaultValue={field.value}
                                                placeholder={data?.defaultCurrency}
                                            />
                                        </SelectTrigger>
                                    </FormControl>
