    ...
    return (
        <div className='overflow-hidden w-full rounded-[16px] border border-solid border-[#DADADA] bg-[#E4F8FF33]'>
            <div className=' w-full bg-[#177196] px-[148px] py-[30px] flex flex-col items-center gap-8'>
                ...
                <RadioGroup defaultValue={'Simple / Open invoice'} className='flex flex-row items-start w-full justify-between'>
                    <div className='w-[223px] flex flex-col items-start'>
                        <div className="flex items-start space-x-2">
                            <RadioGroupItem onClick={() => setToggle(0)} className={`h-[26px] w-[26px] text-[white]  ${!toggle ? "bg-[#ED7F04] border-none" : "border-[white]"}`} value="Simple / Open invoice" id="r1" />
                            <Label className="text-[#FFFFFF] text-[14px] font-[600] leading-normal " htmlFor="r1">Simple / Open invoice</Label>
                        </div>
                    ...
                    <div className='w-[223px] flex flex-col items-start'>
                        <div className="flex items-start space-x-2">
                            <RadioGroupItem onClick={() => setToggle(1)} className={`h-[26px] w-[26px] text-[white]  ${toggle ? "bg-[#ED7F04] border-none" : "border-[white]"}`} value="Standard invoice" id="r2" />
                            <Label className="text-[#FFFFFF] text-[14px] font-[600] leading-normal " htmlFor="r2">Standard invoice</Label>
                        </div>
                        <p className="text-[#FFFFFF] text-[12px] font-[400] leading-normal pl-[34px]">
