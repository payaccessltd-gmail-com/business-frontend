...
const StandardRecipt = ({ receipt, setReceipt, setPopup }: any) => {
    ...
    const handleCopyToClipboard = () => {
        ...
        toast({ variant: "default", title: "Copied", description: `${link}`, className: "bg-[#BEF2B9] border-[#519E47] w-fit h-fit p-[12px]" })
                    ...
                    <div className="relative w-[700px] bg-[#FFFFFF] px-[68px] pt-[45px] pb-[119px] flex flex-col items-center">
                        ...
                        <div className='flex flex-col items-center gap-6 w-full pb-6 border-b border-dashed border-[#999999]'>
                            ...
                            <p className='text-center text-[16px] text-[#555] font-[400] leading-normal w-full'>
                                A request has been sent out to <span className='text-[16px] text-[#177196] font-[700] leading-normal'>Faitholuwande</span>
                            </p>
                        ...
                        <div className='w-full border-b border-dashed border-[#999999] py-8 flex flex-col items-start gap-8'>
                            <div className='flex flex-col items-start gap-2 w-[70%]'>
                                ...
                                <div className="w-full p-1 rounded-[8px] border border-solid border-[#A1CBDE] h-[71px] relative">
                                    <input value={link} onChange={(e) => setLink(e.target.value)} id='link' type="text" placeholder="Copy Link" className="placeholder:text-[#555555] placeholder:text-[16px] placeholder:leading-normal placeholder:font-[400]  pl-[17px] pr-[69px] w-full h-full outline-none border-none bg-transparent" />
                        ...
                        <div className='w-full border-b border-dashed border-[#999999] pt-8 pb-6 flex flex-col items-center gap-6'>
                            {
                                reciptData.map(({ id, title, value }) => {
                                    return (
                                        <NameValue key={id} title={title} value={value} />
                                    )
                                })
                            }
                        ...
                        <div className='flex flex-col items-center w-full pt-20 gap-3'>
                            <Button
