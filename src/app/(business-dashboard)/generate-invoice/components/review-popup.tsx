...
const ReviewPopup = ({ value, setPopup }: any) => {
      ...
      <ScrollArea className="w-full h-full">
        <div className="flex flex-col items-center w-full h-full pb-6 mt-[50px]">
          <div className="rounded-[12px] relative w-[400px] bg-[#FFFFFF] p-6 flex flex-col items-center shadow-[0px_8px_8px_-4px_rgba(16,24,40,0.03)]">
            <div className="flex flex-col items-center justify-center rounded-full min-w-[55px] min-h-[55px] bg-[#F2FCF2]">
              <LuAlertCircle className="text-[24px] text-[#25AF36]" />
            </div>
            <p className="mt-5 text-[#177196] text-[20px] leading-[28px] font-[700]">
              Review
            </p>
            <p className="w-[312px] mt-2 text-[#667085] text-[14px] leading-[20px] font-[400] text-center">
              ...
              } form faitholuwande1@gmail.com`}
            </p>
            <div className="flex flex-col items-center w-full gap-3 mt-8">
              <Button className="min-h-[44px] font-[700] w-full hover:bg-[#1D8EBB] hover:opacity-[0.4]">
                Send Invoice
              </Button>
              <Button
                variant={"outline"}
                className="min-h-[44px] w-full hover:bg-[#1D8EBB] hover:opacity-[0.4] text-[#48B8E6] text-[14px] leading-normal font-[700]"
