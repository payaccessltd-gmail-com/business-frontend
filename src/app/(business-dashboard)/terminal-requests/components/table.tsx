...
const POSTable = ({ terminalTableData, row, setRow, setPage, page }: any) => {
    ...
    const heading = ["S/N", "Terminal Type", "Terminal Brand", "Quantity", "Date Created", "Status"] //------------Table heading array
                    ...
                    <div className="xl:w-full w-[900px]">
                        ...
                        <ScrollArea className='w-full h-[400px]'>
                            <div className='flex flex-col items-center gap-6 w-full mb-6'>
                                {terminalTableData?.list?.map(({ id, quantity, terminalBrand, terminalRequestStatus, terminalType, createdAt }: any, idx: any) => {
                                    return (
                                        <div key={idx} className='p-[10px] border-b border-b-[#BAE5F44F] flex flex-row items-center w-full h-[44px]'>
                                            ...
                                            <p className='text-[#666666] text-[14px] font-[600] leading-[22px] w-[20%] text-center font-raleway'>{quantity}</p>
                                            <p className='text-[#666666] text-[14px] font-[600] leading-[22px] w-[20%] text-center'>{`${dateFormatter(createdAt)}, ${timeFormatter(createdAt)}`}</p>
