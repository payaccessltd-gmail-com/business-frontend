...
import { CategoricalChartState } from "../../../../../node_modules/recharts/types/chart/types"
      ...
      <div className="flex flex-col">
        ...
        <div className="mb-4">
          <ResponsiveContainer width="100%" height={180} className="flex items-center justify-center">
            <PieChart onMouseEnter={onPieEnter} className="flex items-center self-center justify-center">
              <Pie
                data={data}
                innerRadius={35}
                outerRadius={60}
