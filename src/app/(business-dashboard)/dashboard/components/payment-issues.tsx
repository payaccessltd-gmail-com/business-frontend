...
export default function PaymentIssues() {
  return (
    <CardContainer className="">
      ...
      <div className="flex flex-col items-center justify-center w-full h-full m-auto space-y-4">
        <svg
        ...
        <Typography level="LP">
          This chart breaks down the reasons why you have failed transaction
        </Typography>
      </div>
    </CardContainer>
  );
