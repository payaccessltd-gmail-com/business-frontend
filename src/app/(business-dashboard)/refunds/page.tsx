                    ...
                    <DropdownMenuContent align="start" className="w-[298px] p-[22px]">
                      <form className="w-full flex flex-col">
                        ...
                        <div className="flex flex-col items-start mb-[24px]">
                          <label htmlFor="email" className="text-[16px] font-[400px] text-[#0C394B] leading-normal">Amount</label>
                        ...
                        <div className="flex flex-col items-start mb-[24px]">
                          <label htmlFor="email" className="text-[16px] font-[400px] text-[#0C394B] leading-normal">Transaction Reference</label>
                          <input placeholder="Transaction Reference" id="email" type="email" className="px-4 py-2 outline-[#A1CBDE] w-full rounded-[8px] mt-[8px] border border-[#A1CBDE] border-solid h-[45px]" />
                        </div>
                        <Button
