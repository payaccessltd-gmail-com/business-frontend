...
export default function StandardForm({ preFillData }: any) {
  let standardPrefill = preFillData?.invoiceDetails || preFillData
  ...
  const standardForm = useForm<z.infer<typeof StandardSchema>>({
    ...
    defaultValues: {
      customerName: standardPrefill?.customerName,
      email1: standardPrefill?.customerEmail,
      email2: standardPrefill?.additionalCustomerEmailAddress.split(",")[0],
      email3: standardPrefill?.additionalCustomerEmailAddress.split(",")[1],
      invoiceItem: "",
      qty: "",
      costPerUnit: "",
      // invoiceItem2: "",
      ...
      // qty3: 0,
      // costPerUnit3: 0,
      dueDate: standardPrefill?.dueDate ? (new Date(preFillData?.dueDate)) : undefined,
      // amount: 0,
      invoiceNote: standardPrefill?.invoiceNote,
      // logo: "",
      taxPercent: "",
      discountType: "PERCENTAGE",
      discountAmount: "",
      shipping: standardPrefill?.shippingFee,
    },
  })
  ...
  console.log("standard edit ID: ", standardPrefill?.id)
