        ...
        <div className='flex flex-row max-[1070px]:flex-col max-[1070px]:gap-10 items-center justify-between px-[100px] max-[1160px]:pr-[20px] pt-16 pb-12 bg-[#07222D]'>
            ...
            <div className='max-[664px]:grid-cols-2 max-[756px]:grid-cols-4 grid grid-cols-5 w-[65%] max-[1070px]:w-full min-[1400px]:w-[68%] min-[1500px]:w-[63%] min-[1700px]:w-[60%]'>
                <div className='flex flex-col items-start gap-3'>
                    ...
                    <Link className='text-[16px] text-[#EAECF0] font-[400] leading-6' href={"/"}>
                        Payment
                    </Link>
                    <Link className='text-[16px] text-[#EAECF0] font-[400] leading-6' href={"/"}>
                        Products
                    </Link>
                    <Link className='text-[16px] text-[#EAECF0] font-[400] leading-6 flex flex-row items-center gap-2' href={"/"}>
                        Solutions
                        <p className='flex flex-row items-center justify-center w-[42px] h-[22px] text-[12px] leading-[18px] font-[500] text-center rounded-2xl bg-[#F2F4F7] text-[#07222D]'>New</p>
                    </Link>
                    <Link className='text-[16px] text-[#EAECF0] font-[400] leading-6' href={"/"}>
                        SME
                    </Link>
