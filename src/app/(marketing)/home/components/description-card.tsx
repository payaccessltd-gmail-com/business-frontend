  ...
  return (
    <div className={`flex items-center gap-8 ${direction === "reverse" ? "flex-col-reverse lg:flex-row-reverse" : "flex-col lg:flex-row"}`}>
      <div className="flex flex-col items-start gap-4 w-[80%] lg:w-[494px]">
        ...
        <Link className="flex flex-row gap-2 items-center text-primary group text-[14px] hover:text-primary/70 leading-5 font-[700]" href={link}>
          {linktext}
          <LuChevronRight className="text-[24px] text-primary group-hover:text-primary/70" />
        </Link>
      </div>
