...
const JoinWidget = () => {
  return (
    <div className="w-full py-[55px] flex flex-col items-center px-[24px]">
      <div className="bg-primary/5 rounded-[16px] flex flex-col items-center gap-8 py-8 px-2 w-full lg:w-[877px]">
        ...
        <Button className="h-[48px] w-[234px] rounded-[7px] text-[16px] font-[700] leading-[147%] text-[#ffffff] shadow-none">Get Started</Button>
      </div>
    </div>
  )
}
