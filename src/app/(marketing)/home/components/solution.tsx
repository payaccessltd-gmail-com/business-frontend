  ...
  return (
    <div className="relative flex w-full flex-col items-center bg-[#5A99DC0F] pb-[113.92px]">
      <div className="my-[55px] flex w-[85%] lg:w-[941px] flex-col items-center gap-[20px]">
        ...
        <Typography level="p" className="text-center font-Poppins text-[18px] font-[400] leading-[30px] text-[#52525B]">
          Pay access Certainly! I can provide you with information about payment transactions. or question you have
          regarding payment transactions, and I'll be glad .
        </Typography>
      </div>
      <div className="w-full gap-4 flex flex-row items-center justify-center">
        ...
        <LuChevronRight onClick={() => Next()} className="text-[#115570] text-[30px] cursor-pointer" />
      </div>
    </div>
  )
}
